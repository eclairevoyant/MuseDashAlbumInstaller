...
#define MyAppName "MuseDashAlbumInstaller"
...
AppId={{3EDD47D9-BF68-4EA1-9F6C-EB9ED3C7092F}
AppName={#MyAppName}
...
DefaultGroupName=startmenustuff
DisableProgramGroupPage=yes
LicenseFile=C:\Users\lia\git\MuseDashAlbumInstaller\LICENSE
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
OutputDir=C:\Users\lia\git\MuseDashAlbumInstaller\bin
OutputBaseFilename=MuseDashAlbumInstaller
Compression=lzma
...
Root: HKA; Subkey: "Software\Classes\Applications\{#MyAppExeName}\SupportedTypes"; ValueType: string; ValueName: ".mdm"; ValueData: ""
